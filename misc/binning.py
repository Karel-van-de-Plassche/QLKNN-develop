import pandas as pd; import numpy as np; import xarray as xr; import seaborn as sns; import matplotlib.pyplot as plt
...
def plot_zerohist(dfs, name, ax=None, symmetric=True, plot_zero=True, statnames=None):
    ...
    for df, color in zip(dfs, default_colors):
        ...
        dfnozeroinf = dfnozero.loc[(dfnozero != -np.inf) & (dfnozero != np.inf) & ~dfnozero.isnull()]
